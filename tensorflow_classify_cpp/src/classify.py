...
class ClassifyModel(object):
  ...
  def __init__(self, frozen_graph=None, input_tensor_name=None, output_tensor_name=None):
    ...
    self.labels = self.load_labels("/home/ubuntu/eclipse-workspace/facenet/tensorflow_cpp/data/imagenet_slim_labels.txt")
...
def run_classification(ClassifyModel,path):
    ...
    digital = ClassifyModel.labels[ClassifyModel.prediction]
    print(digital)
...
def main():
    ...
    BASE_PATH = '/home/ubuntu/eclipse-workspace-cpp/tensorflow-cpp/data/'
    TEST_IMAGES= ["grace_hopper.jpg"]
    print(TEST_IMAGES)

    MODEL = ClassifyModel("/home/ubuntu/eclipse-workspace/facenet/tensorflow_cpp/data/inception_v3_2016_08_28_frozen.pb",INPUT_TENSOR_NAME,OUTPUT_TENSOR_NAME)
    
    for image in TEST_IMAGES:
        image_path = os.path.join(BASE_PATH, image)
        run_classification(MODEL,image_path)
